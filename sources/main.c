...
/*   Updated: 2016/01/09 23:26:20 by                  ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	ft_draw_rect(ft_draw_make_area(210, 510, 110, 460), mlx, (int)0x00ff00);
	...
	ft_draw_losange(ft_draw_make_area(100, 200, 150, 300), 80, mlx, (int)0xffffff);
	ft_draw_isocele(ft_draw_make_area(300, 200, 400, 300), 30, mlx, (int)0xff0000);
