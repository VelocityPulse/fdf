...
/*   Updated: 2016/01/12 15:41:13 by cchameyr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main()
{
	...
	line = ft_draw_make_line(45, 100, 205, 400);
	ft_draw_losange(ft_draw_make_losange(line, 56), mlx, (int)0xff00ff);
	line = ft_draw_make_line(100, 50, 310, 200);
	ft_draw_isocele(ft_draw_make_isocele(line, -100), mlx, (int)0xff0000);
