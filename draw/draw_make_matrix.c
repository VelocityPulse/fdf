...
/*   Updated: 2016/01/22 23:23:20 by                  ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	m.x = ft_add_vector(m.x, 1.0f * scale.x, 0.0f, 0.0f);
...
t_matrix	ft_rotate_matrix_y(t_matrix m, float rot, t_vector scale)
{
	...
	m.y = ft_add_vector(m.y, 0.0f, 1.0f * scale.y, 0.0f);
...
t_matrix	ft_rotate_matrix_z(t_matrix m, float rot, t_vector scale)
{
	...
	m.z = ft_add_vector(m.z, 0.0f, 0.0f, 1.0f * scale.z);
	return (m);
}
